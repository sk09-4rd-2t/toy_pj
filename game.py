...
# 졸라맨 그리기 함수
def draw_stickman(x, y, arm_angle=0, leg_angle=0):
    # 머리
    # y -= 70
    ...
    # 몸통
    pygame.draw.line(screen, WHITE, (x, y - 10), (x, y + 30), 2)
    # 기본 팔
    pygame.draw.line(screen, WHITE, (x - 20, y), (x + 20, y), 2)
    ...
    pygame.draw.line(screen, WHITE, (x - 20, y), left_arm_end, 3)
    pygame.draw.line(screen, WHITE, (x + 20, y), right_arm_end, 3)

    # 다리 (움직임 반영)
    left_leg_end = (x - 20, y + 90 + int(leg_angle))
    right_leg_end = (x + 20, y + 90 - int(leg_angle))

    pygame.draw.line(screen, WHITE, (x, y + 30), left_leg_end, 2)
    pygame.draw.line(screen, WHITE, (x, y + 30), right_leg_end, 2)
